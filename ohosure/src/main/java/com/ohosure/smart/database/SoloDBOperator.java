...
public class SoloDBOperator {
    ...
    public void insertOrUpdatePtControlDevice(long controlDeviceId, String controlDeviceName,
                                              long roomAreaId, int controlDeviceType) {
        Cursor cursor = OsApplication
                .getContext()
                .getContentResolver()
    ...
    public void insertOrUpdatePtProduct(long productId, int productType, String productName,
                                        long roomAreaId) {
    ...
    public void updatePtProduct(long productId, String productName, long roomAreaId) {
        Cursor cursor = OsApplication
                .getContext()
                .getContentResolver()
                .query(HSmartProvider.MetaData.Product.CONTENT_URI,
    ...
    public void updatePtProductSceneConfig(long productId, long sceneId) {
        Cursor cursor = OsApplication
                .getContext()
                .getContentResolver()
                .query(HSmartProvider.MetaData.Product.CONTENT_URI,
